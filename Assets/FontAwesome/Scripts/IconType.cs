...
public class FontAwesomeIcons
{
    ...
    private static Dictionary<string, string> faMap = new Dictionary<string, string>
    {
        {"fa-adjust", "0xf042"},
        {"fa-adn", "0xf170"},
    ...
    private static  string UNKNOWN_CODE = "fa-question";

    public static string GetIcon(string iconType)
    {

        return faMap[iconType];
    }

    public static string getUnicode(string iconCode)
    {
        string unicode = faMap[iconCode];
        return (unicode == null) ? faMap[UNKNOWN_CODE] : unicode;
    }
}
